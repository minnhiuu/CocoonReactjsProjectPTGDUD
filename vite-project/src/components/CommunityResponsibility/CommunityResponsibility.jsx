...
const CommunityResponsibility = () => {
  ...
  return (
    <>
        ...
        <div className="content-section">
          <div className="community-content">
            ...
            <ul>
              ...
              <li>
                Sử dụng bao bì thân thiện môi trường, hạn chế nhựa dùng một lần.
              </li>
            ...
            <ul>
              ...
              <li>
                Tạo việc làm cho phụ nữ nông thôn qua hợp tác sản xuất nguyên
                liệu.
              </li>
      ...
      <p className="quote">
        💖 Cocoon tin rằng kinh doanh không chỉ là lợi nhuận, mà còn là sự sẻ
        chia và trách nhiệm với xã hội!
      </p>
    </>
  );
};
