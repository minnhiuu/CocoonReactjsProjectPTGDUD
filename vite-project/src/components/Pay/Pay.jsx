    ...
    return (
        <div className="payment-modal">
            <div className="payment-modal-content">
                ...
                <h2>Thanh Toán</h2>
                <p>Hãy điền vào mẫu dưới đây để hoàn tất việc mua hàng của bạn!</p>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="checkout-grid">
                        ...
                        <div className="checkout-column">
                            <div className="section">
                                <h3>4. Xem lại đơn hàng của bạn</h3>
                                    ...
                                    {cartItems && cartItems.length > 0 ? (
                                        cartItems.map(item => (
                                            <div className="order-item" key={item.id}>
                                                <p>{item.title}</p>
                                                <p>{item.quantity}</p>
                                                <p>{formatCurrency(Number(item.price.replace(/\./g, "").replace(" đ", "")) * item.quantity)}</p>
                                            </div>
                                        ))
                                    ) : (
